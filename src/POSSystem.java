...
public class POSSystem {
  ...
  private void logInToFile(String username, String name, String position, Calendar cal) {
    try {
      ...
      // if(System.getProperty("os.name").startsWith("W")||System.getProperty("os.name").startsWith("w")){
      // temp = "..\\Database\\employeeLogfile.txt"; //commented out to support
      // netbeans
      // }
      FileWriter fw = new FileWriter(temp, true);
      BufferedWriter bw = new BufferedWriter(fw);
      String log = name + " (" + username + " " + position + ") logs into POS System. Time: "
  ...
  private void logOutToFile(String username, String name, String position, Calendar cal) {
    try {
      ...
      FileWriter fw = new FileWriter(temp, true);
      BufferedWriter bw = new BufferedWriter(fw);
      String log = name + " (" + username + " " + position + ") logs out of POS System. Time: "
          + dateFormat.format(cal.getTime());
      bw.write(log);
      bw.write(System.getProperty("line.separator"));
      bw.close();
